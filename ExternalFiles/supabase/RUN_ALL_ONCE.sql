...
FROM (VALUES
  ('חלב 3%',        'חלב וביצים'),
  ('גבינה צהובה 200 גרם', 'חלב וביצים'),
  ('לחם פרוס',      'לחם ומאפים'),
  ('ביצים 12',      'חלב וביצים'),
  ('עגבניות',       'פירות וירקות'),
  ('מלפפונים',      'פירות וירקות'),
  ('בננות',         'פירות וירקות'),
  ('תפוחים',        'פירות וירקות'),
  ('חזה עוף',       'בשר, עוף ודגים'),
  ('אורז 1 ק"ג',   'פסטה, אורז וקטניות'),
  ('פסטה 500 גרם',  'פסטה, אורז וקטניות'),
  ('שמן זית',       'תבלינים, אפייה ושמנים'),
  ('נייר טואלט',    'ניקיון וחד פעמי'),
  ('סבון כלים',     'ניקיון וחד פעמי'),
  ('קפה טורקי',     'שתייה')
